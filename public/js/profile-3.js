  ...
  for (let i = 0; i < hobbies.length; i++) {
    $(".hobbies").append(`
        <div class="custom-control custom-checkbox custom-control-inline">
          <input type="checkbox" class="custom-control-input" id="customCheck${i}" name="hobbies" value="${hobbies[i]}">
          <label class="custom-control-label" for="customCheck${i}">${hobbies[i]}</label>
      </div>`);
  }
  //add hobbies button
  var max_fields = 10;
